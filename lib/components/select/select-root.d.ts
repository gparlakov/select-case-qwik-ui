...
export declare const SelectImpl: import("@builder.io/qwik").Component<(Omit<{
    ...
    /** A signal that controls the current open state (controlled). */
    'bind:open'?: Signal<boolean> | undefined;
    'bind:displayText'?: Signal<string | string[]> | undefined;
    /**
     * QRL handler that runs when a select value changes.
     * @param value The new value as a string.
     */
